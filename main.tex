...
\begin{figure}[!ht]
\begin{center}
\includegraphics[angle=0, width=0.46\textwidth]{images/timingER3.pdf}
\end{center}
...
performs better than MPTCP in asymmetric scenarios with a lower delay on the alternate path. This improvement is for the reason that MPTCP-New 
allows the packet to be retransmitted on the alternate path much before the RTO. In two packet tail loss scenario as in Figure~\ref{2pn}, MPTCP-New
