...
mechanism. Our experimental results indicate a consistent improvement in the performance of TLP by reducing 
...
in Figure~\ref{tcpf}, then TLP performs better than RTO retransmission as it waits for one 
